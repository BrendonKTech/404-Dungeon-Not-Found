...
// Refresh hand cards
if (refresh_cards) {
    with (obj_cardParent2) instance_destroy(); // destroy all old cards

    // Spawn new hand (example 3 cards, can adjust)
    var inst3 = instance_create_layer(640, 960, "Instances", obj_card1);
    inst3.image_xscale = 0.5; inst3.image_yscale = 0.5;

    var inst4 = instance_create_layer(944, 960, "Instances", obj_card1);
    inst4.image_xscale = 0.5; inst4.image_yscale = 0.5;

    var inst5 = instance_create_layer(1248, 960, "Instances", obj_card2);
    inst5.image_xscale = 0.5; inst5.image_yscale = 0.5;
